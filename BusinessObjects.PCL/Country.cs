...
namespace BusinessObjects.PCL
{
    ...
    /// Derived from: https://github.com/schourode/iso3166/blob/master/Country.cs 
    /// </summary>
    public class Country
    {
        ...
        /// <summary>
        /// ISO_3166-1 alpha 2 (two letter code).
        /// </summary>
        public string TwoLetterCode { get; private set; }
        /// <summary>
        /// ISO_3166-1 alpha 3 (three letter code).
        /// </summary>
        public string ThreeLetterCode { get; private set; }
        /// <summary>
        /// ISO_3166-1 Numeric (numeric code).
        /// </summary>
        ...
        /// <summary>
        /// Array of ISO_3166-1 alpha 2 codes.
        /// </summary>
        public static string[] TwoLetterCodes
        {
            get { return List.Select(x => x.TwoLetterCode).ToArray(); }
        }
        /// <summary>
        /// Array of ISO_3166-1 alpha 3 codes.
        /// </summary>
        public static string[] ThreeLetterCodes
        {
            get { return List.Select(x => x.ThreeLetterCode).ToArray(); }
        }
        /// <summary>
        /// Array of ISO_3166-1 Numeric codes.
        /// </summary>
        public static string[] NumericCodes
        {
            get { return List.Select(x => x.NumericCode).ToArray(); }
        }
        /// <summary>
        ...
        {
            get { return List.Select(x => x.Name).ToArray(); }
        }
